Test: 2 spheres
1    0  -1  2 fill=1          imp:n=1
2    0  -1 -2 fill=2 (-8 0 0) imp:n=1
3    0   1                    imp:n=0
11  10   -2.0  -11 u=1 imp:n=1
12          0   11 u=1 imp:n=1
21  20  -10.0  -11 u=2 imp:n=1
22          0   11 u=2 imp:n=1
...
c data cards
idum 1000 4      $ for material detection: idum(0): number of hits 1/cm3, idum(1): mesh tally number
sdef pos -4 0 0
c =========================== NEUTRON FLUX MESHES =======================================
fmesh4:n origin -10 -10 -10
        imesh -4 4 10 iints 3  8 3
        jmesh -8 8 10 jints 1 16 1
        kmesh -8 8 10 kints 1 16 1
fm4 1e19   $ normalization for neutron flux intensity. Can also be given in the inventory input template, FLUX keywords.
fmesh44:n origin -10 -10 -10
        imesh -4 4 10 iints 1  4 1
        jmesh -8 8 10 jints 1  8 1
        kmesh -8 8 10 kints 1  8 1
      emesh=1.00001e-07 4.13994e-07 5.31579e-07 6.82560e-07 8.76425e-07
